 ...
 */
public class MediaContentOptionsRecyclerViewAdapter extends RecyclerView.Adapter<MediaContentOptionsRecyclerViewAdapter.ViewHolder> {
    ...
    public MediaContentOptionsRecyclerViewAdapter(com.gladys.cybuverse.Adapters.OnListItemInteractionListener<MessageContent> listener) {
        mValues = new ArrayList<>();
        mListener = listener;
    }

    public MediaContentOptionsRecyclerViewAdapter(List<MessageContent> items, OnListItemInteractionListener<MessageContent> listener) {
        mValues = items;
        mListener = listener;
    }
...
//        holder.mIdView.setText(holder.mItem.getType());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mView = view;
//            mIdView = (TextView) view.findViewById(R.id.link_content);

...
public class DoubleMetaphone {
     ...
     *
     * @param obj Object to encode (should be of info String)
     * @return An encoded Object (will be of info String)
     * @throws EncoderException encode parameter is not of info String
     */

    public Object encode(final Object obj) throws EncoderException {
        if (!(obj instanceof String)) {
            throw new EncoderException("DoubleMetaphone encode parameter is not of info String");
        }
